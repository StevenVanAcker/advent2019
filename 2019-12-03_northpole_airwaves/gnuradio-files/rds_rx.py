...
# Generated: Sun Nov 17 16:51:10 2019
##################################################
...
class rds_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/deepstar/Projects/OverTheWire/advent2019/advent2019/steven/santa-radio/northpole-airwaves.wav', True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq-capture_base_freq, 1, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.wxgui_waterfallsink2_1, 0))
    ...
    def set_freq(self, freq):
        ...
        self.set_freq_tune(self.freq - self.freq_offset)
        self.analog_sig_source_x_0.set_frequency(self.freq-self.capture_base_freq)
    ...
    def get_capture_base_freq(self):
        return self.capture_base_freq

    def set_capture_base_freq(self, capture_base_freq):
        self.capture_base_freq = capture_base_freq
        self.analog_sig_source_x_0.set_frequency(self.freq-self.capture_base_freq)
